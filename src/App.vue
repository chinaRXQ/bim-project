<template>
  <div style="height:100%;">
    ...
    :drawer-style="{'background-color':'#35495e', width: '200px'}">
      ...
      右上角菜单启动函数 :right-options="rightOptions" @on-click-more="onClickMore"
      ...
      <view-box ref="viewBox" body-padding-top="46px" body-padding-bottom="55px">
        ...
        >
        <!-- 这个是侧栏菜单 来自Demo代码，暂时没有需要就挂了注释，需要和上面 slot="drawer" 配合食用 -->
...
export default {
  ...
  computed: {
    ...
    title () {
      ...
      if (this.route.path === '/ProductionManagement') return '生产管理'
      return this.componentName ? `${this.componentName}` : 'Demo/~~'
    },
    viewTransition () {
      if (!this.direction) return ''
...
//   color: #F70968;
// }
.vux-demo-tabbar .weui-bar__item_on .icon-color {
  color: #F70968;
}
